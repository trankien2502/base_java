...
public class ProtractorView extends View {
    ...
    private void init() {
        bitmapProtractor = getBitmapFromDrawable(R.drawable.img_potractor_view);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                float distanceToLine1 = distanceFromPointToLine(centerPoint, touchPointLine1, touchPoint);
                float distanceToLine2 = distanceFromPointToLine(centerPoint, touchPointLine2, touchPoint);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (touchLine == 1) {
                    touchPointLine1.set(touchPoint.x, touchPoint.y);
                } else if (touchLine == 2) {
                    touchPointLine2.set(touchPoint.x, touchPoint.y);
                }
