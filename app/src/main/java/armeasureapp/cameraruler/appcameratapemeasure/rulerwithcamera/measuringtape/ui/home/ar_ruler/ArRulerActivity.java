...
import armeasureapp.cameraruler.appcameratapemeasure.rulerwithcamera.measuringtape.databinding.ActivityArRulerBinding;

import java.util.Arrays;

public class ArRulerActivity extends BaseActivity<ActivityArRulerBinding> implements SensorEventListener {
    ...
    int i = 0;
    int countPlace = 0;
    String type = "on the ground";
    Dialog dialog;
    private int checkGuidIndex = 1;

    @Override
    public ActivityArRulerBinding getBinding() {
        return ActivityArRulerBinding.inflate(getLayoutInflater());
    }
    ...
    public void bindView() {
        ...
        binding.ivReset.setOnClickListener(view -> {
            ...
            binding.resultView.ivResultHeight.setImageResource(R.drawable.img_ar_ruler_step1);
        ...
        binding.ivGuide.setOnClickListener(view -> {
            resultLauncher.launch(new Intent(this, GuideArRulerActivity.class));
        });
        binding.ivRuler.setOnClickListener(view -> {
            ...
            if (countPlace < 2) {
                countPlace++;
                if (countPlace == 1) {
                    binding.resultView.ivResultHeight.setImageResource(R.drawable.img_ar_ruler_step2);
                    binding.ivRuler.setImageResource(R.drawable.img_ruler_2);
                }
                if (countPlace == 2) {
                    binding.resultView.ivResultHeight.setImageResource(R.drawable.img_ar_ruler_step3);
    ...
    private void bindPreViewToCaptureImage() {
        cameraProvider.unbindAll();
        cameraProvider.bindToLifecycle((LifecycleOwner) ArRulerActivity.this, cameraSelector, preview);
    }
...
//            binding.resultView.tvHumanHeight.setText(object_height_from_ground+"cm");
    ...
    void take_angles() {
        ...
        Log.e("angle_roll", String.valueOf(Math.toDegrees(orientation[2])));
        if (down_angle == 0)
...
//            touch_ground_switch.setVisibility(View.INVISIBLE);
    ...
    void object_on_eyes_level_calc() {
        ...
        binding.resultView.tvObjectHeight.setText(String.format("%.1f", length_of_object) + "cm");
        binding.resultView.tvDistanceToObject.setText(String.format("%.1f", distance_from_object) + "cm");
        binding.resultView.tvHumanHeight.setText(String.format("%.0f", object_height_from_ground) + "cm");
    }
