...
import armeasureapp.cameraruler.appcameratapemeasure.rulerwithcamera.measuringtape.dialog.LoadingDialog;
...
public abstract class BaseActivity<VB extends ViewBinding> extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!(this instanceof IntroActivity) && !(this instanceof ArRulerActivity) && !(this instanceof TapeMeasureActivity)) {
