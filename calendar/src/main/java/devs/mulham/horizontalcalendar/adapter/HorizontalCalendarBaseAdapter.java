...
public abstract class HorizontalCalendarBaseAdapter<VH extends DateViewHolder, T extends Calendar> extends RecyclerView.Adapter<VH> {
    ...
    protected void applyStyle(VH viewHolder, boolean isSelect) {
        if (isSelect) {
            viewHolder.textTop.setTextColor(Color.parseColor("#000000"));
            viewHolder.textMiddle.setTextColor(Color.parseColor("#000000"));
            viewHolder.textBottom.setTextColor(Color.parseColor("#000000"));
            viewHolder.itemView.setBackgroundResource(R.drawable.bg_date_select);
            viewHolder.viewSelect.setVisibility(View.VISIBLE);
        } else {
            viewHolder.textTop.setTextColor(Color.parseColor("#000000"));
            viewHolder.textMiddle.setTextColor(Color.parseColor("#000000"));
            viewHolder.textBottom.setTextColor(Color.parseColor("#000000"));
            viewHolder.itemView.setBackgroundResource(R.drawable.bg_date_unselect);
